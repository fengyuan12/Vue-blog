    ...
    <div class="editor">
      ...
      <div class="operate-bar">
        <section class="tag-container">
          ...
          <input type="text" v-if="showTags" class="tag-input" id="tag-input" @keydown.enter="addTag">
  ...
  import request from '@/utils/request'
    export default {
      ...
      mounted(){
        ...
        // 通过键映射处理键后触发。name是已处理键的名称（例如"Ctrl-X"或"'q'"），
        // event是DOM keydown 或keypress事件。
      ...
      methods:{
        ...
        addTag(){
          ...
          //只是有个单纯的切换功能，第一次点击+的时候显示input表单，第二次
        ...
        deleteArticle(){
          request({
            ...
            this.$store.commit('SET_DELETE_ARTICLE',this.id)
          }).catch(err=>{
            console.log(err)
          })
        },
